...
function tsDraw(p_id, p_table)
{
	...
	if	(classes == null)
	{
		for (var i in row_clones){
		    new_tbody.appendChild (row_clones[i].cloneNode(true));
		    new_tbody.appendChild (skippedRows[row_clones[i].tsort_row_id+1].cloneNode(true));
		}
	}
	else
	{
